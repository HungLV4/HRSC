...
class BOV:
	...
	def trainModel(self):
		...
		for word, imlist in self.images.items():
			...
			for im in imlist:
				...
				# des = self.im_helper.extract_hog(im)
	...
	def recognize(self, test_img, test_image_path=None):
		...
		# des = self.im_helper.extract_hog(test_img)
	...
	def testModel(self):
		...
		# print(predictions)
		print("Acc: ", right, "/", count, "=", (right/count))
...
if __name__ == '__main__':
	...
	parser.add_argument('--train_path', action="store", dest="train_path", required=False, default="images\\train\\")
	parser.add_argument('--test_path', action="store", dest="test_path", required=False, default="images\\test\\")
